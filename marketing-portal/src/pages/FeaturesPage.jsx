...
const FEATURES = [
  {
    ...
    badge: 'CORE FEATURE',
    desc: 'Activate your decentralized mining node with a single BNB transaction on BSC. Your node starts generating $AIPCORE tokens immediately at 100 coins/hour, upgrading to 200/hr on Tier 2.',
  ...
  },
  {
    ...
    badge: 'ECOSYSTEM',
    desc: 'Participate in AI-hosted virtual summits, networking halls, and community events inside the AIPCore Core Metaverse — exclusive to active node holders.',
...
const HOW_IT_WORKS = [
  ...
  { step: '03', title: 'Mine $AIPCORE 24/7', desc: 'Your node auto-mines $AIPCORE tokens every hour — online or offline.', color: '#FF6BFF' },
  ...
  return (
    <main style={{ paddingTop: 104 }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="section-desc" style={{ margin: '0 auto 40px' }}>
              AIPCore Core combines AI-powered community tools with a bulletproof DeFi income engine — all on BNB Smart Chain.
            </p>
      ...
      <section className="section" style={{ background: 'rgba(255,255,255,0.01)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="container">
          <SectionHeader label="HOW IT WORKS" title="Up & Running in Minutes" desc="Four simple steps to activate all income streams on the AIPCore Core protocol." center />
