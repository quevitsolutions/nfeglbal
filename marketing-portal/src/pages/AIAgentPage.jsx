...
const PROMPT_TEMPLATES = [
  { icon: Twitter, label: 'Write Twitter Thread', prompt: 'Write a highly engaging 5-part Twitter thread about AIPCore Core\'s new 18-tier matrix and how to earn passive BNB. Use emojis and a strong hook.' },
  { icon: MessageSquare, label: 'Telegram Promo', prompt: 'Draft a short, high-energy Telegram announcement for my group about joining my AIPCore Core node downline.' },
  { icon: MessageCircle, label: 'WhatsApp Pitch', prompt: 'Write a casual, friendly WhatsApp message to pitch the AIPCore Core mining node to a friend.' },
...
export default function AIAgentPage() {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: "Hello! I'm Bella, your AIPCore Marketing AI. I can write tweets, Telegram posts, scripts, or explain the protocol to your prospects. What do you need to promote today?" }
  ])
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', width: '100%', padding: '0 24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', background: 'rgba(206,147,216,0.1)', color: '#CE93D8', borderRadius: 20, fontSize: 13, fontWeight: 900, marginBottom: 16 }}>
            <Bot size={16} /> AIPCore AI MARKETING AGENT
          </div>
