...
const ANNOUNCEMENTS = [
  { title: 'Webinar Tonight 8PM UTC', msg: 'AI Income Masterclass — 500 $AIPCORE reward for attendance!', time: '2h ago', icon: '📢', urgent: true },
  { title: 'New DAO Proposal AIPCore-009', msg: 'Vote to increase referral commission to 15%. Ends in 1 day.', time: '5h ago', icon: '🗳️', urgent: false },
...
const GLOBAL_CHAT = [
  ...
  { user: '🐯 0xa91...', msg: 'New proposal AIPCore-009 looks great — voting FOR', time: '3m' },
  { user: '🦊 0x3c4...', msg: 'Anyone joining the webinar tonight?', time: '5m' },
  { user: '🤖 AI Host', msg: 'Welcome to AIPCore Community Hub! Tonight\'s masterclass starts at 8PM UTC 🎙️', time: '10m', isAI: true },
];

export default function AIPCoreCommunityScreen({ onBack, onNavigate }) {
  ...
  return (
    <div style={{ paddingBottom: 24 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
        ...
        <div>
          <h1 style={{ fontSize: 18, fontWeight: 900 }}>🌐 AIPCore Community Hub</h1>
